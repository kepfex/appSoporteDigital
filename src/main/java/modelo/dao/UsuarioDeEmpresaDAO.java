 ...
 * @author KEVIN
 */
public class UsuarioDeEmpresaDAO extends AbstractDAO<UsuarioDeEmpresa>{
    private final RolDAO rolDAO = new RolDAO();
    @Override
    protected UsuarioDeEmpresa mapResultSetToEntity(ResultSet rs) throws SQLException {
        int idRol = rs.getInt("tb_rol_id");
    ...
    protected String getInsertQuery() {
        return "INSERT INTO tb_usuario "
                ...
                + "tb_usuario_corele, tb_usuario_act, tb_usuario_tip, tb_rol_id, confirmado, token) "
                + "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    }
    ...
    @Override
    protected void setEntityValues(PreparedStatement ps, UsuarioDeEmpresa entidad) throws SQLException {
        ...
        ps.setInt(9, entidad.getRol().getId());
